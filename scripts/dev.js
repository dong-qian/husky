...
function printInstructions(appName) {
  console.log(`You can now load ${chalk.bold(appName)} from ${chalk.bold('chrome://extensions')}.`);
  console.log(
    `Remember to select the ${chalk.bold('/build')} folder when loading the unpacked extension.`
  );
  console.log();

  console.log();
  console.log('Note that the development build is not optimized.');
  console.log('Use "npm run assemble" to build and ZIP your extension for production.');
  console.log();
}
